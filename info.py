...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/cine_hunts_movies_group')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'cine_hunts_movies_group') # Support Chat Link Without https:// or @
